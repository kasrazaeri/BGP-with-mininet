...
class MyTopology(IPTopo):
    ...
    def build(self, *args, **kwargs):
        ...
        prefix = {routers[i]: '2001:cafe:%04x:1::/64' % (i+1) for i in range(len(routers ))}
        ...
        l12[as1].addParams(ip="2001:cafe:12:1::1/64")
        l12[as2].addParams(ip="2001:cafe:12:1::2/64")
        
        l13=self.addLink(as1, as3, delay='10ms')
        l13[as1].addParams(ip="2001:cafe:13:1::1/64")
        l13[as3].addParams(ip="2001:cafe:13:1::3/64")
        l23=self.addLink(as2, as3, delay='200ms')
        l23[as2].addParams(ip="2001:cafe:23:1::2/64")
        l23[as3].addParams(ip="2001:cafe:23:1::3/64")
    ...
    def post_build(self, net):
        for r in self.routers():
            command="/usr/sbin/tcpdump --immediate-mode -c 100 -w ./bgp-"+r+"-trace.pcap tcp port 179"
